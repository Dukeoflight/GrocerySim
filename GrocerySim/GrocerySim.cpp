...
int main(int argc, char* argv[])
{
	...
	ExpressLine* ExpressLane = new ExpressLine("Express Lane");
	NormalLine* NormalLane = new NormalLine("Normal Lane");
	...
	for (int i = 0; i < minutes; i++) {
		...
		customer = ExpressLane->MinutePasses(i); // should call
